...
\subsection{Upload}
Uploads the code to the microcontroller, after asking for the board name and COM port.
\subsection{Test}
...
This button runs the code through the transpiler without asking anything. It helps you to find out whether an error happens before or \emph{after} the actual transpilation step.
\subsection{Run}
...
\textcolor{red}{YES}, HobbySpark has a built-in birthday wishing system. It features a small window popup and playing of a "Happy Birthday To You" song that's in the public-domain.
...
\begin{itemize}
	...
	\item settings.json
\end{itemize}
Note that main.py is both a file \emph{and} a folder. The folder contains the generated code and the HobbySpark package, while the file contains the actual python code that you write.
