...
We have learnt about the GUI, but what about the actual code? This is the exact thing we are learning here.
...
It requires four arguments and accepts an optional address:
...
\begin{itemize}
    ...
    \item \texttt{InvalidArgumentError} is raised if \texttt{unit} is not an
    \texttt{int}.
\end{itemize}
